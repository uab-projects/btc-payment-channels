...
if __name__ == "__main__":
    ...
    # Transaction fields
    prev_tx = bytes().fromhex("""40d271f31d4249e4c58a952348dff8f211b71edbf646086
                              b1faf17561f0696f9""")
    prev_tx_out = 0
    ...
    # Add outputs
    out_0 = TxOutput()
    out_0.script = script.pubkey.P2SH(address.P2SH(Network.testnet, rS))
    out_0.btc = to_pay
    ...
    # Add outputs
    out_1 = TxOutput()
    out_1.script = script.pubkey.P2PKH(address.P2PKH.decode(to_pay_addr))
    out_1.btc = to_pay
    transaction.add_output(out_1)

    # Add inputs
    in_1 = TxInput(prev_tx, 0)
    transaction.add_input(in_1)
